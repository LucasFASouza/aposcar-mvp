      ...
      <div className="border bg-neutral-900 border-neutral-800 rounded-xl p-6 lg:w-2/3 mx-auto my-8">
        ...
        <div className="text-base lg:text-lg flex flex-col gap-4">
          ...
          <p>
            ...
            taking home the gold in each category. Main categories pack a punch
            at 10 points, while the others weigh in at a cool 5.
          </p>
          <p>
            <h3 className="text-lg lg:text-2xl py-2 font-semibold">
              📜 Cinephile Status
            ...
            "Cinephile Extraordinaire" (and brace yourself for the bullying that
            come with it).
          </p>
          <p>
            <h3 className="text-lg lg:text-2xl py-2 font-semibold">
            ...
            Elevate your Aposcar profile by linking your Letterboxd account and
            rocking a personalized Picrew pic as your avatar. It's the cinephile
            flex you've been waiting for.
          </p>
          <p>
            <h3 className="text-lg lg:text-2xl py-2 font-semibold">
          ...
          <p>
            ...
            Want to be a part of the behind-the-scenes action? Head over to our{" "}
            <Link
